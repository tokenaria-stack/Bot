...
func WozduhComponents() []core.UIComponent {
	return []core.UIComponent{
		...
		wozChannel("woz_vol_rsi_ema5_chan",
			`{"title":"Volume RSI EMA5 channel","defaultVisible":false,"lastValueVisible":false,"priceLineVisible":false,"plots":{"upper":"woz_vol_rsi_ema5_chan_up","mid":"woz_vol_rsi_ema5_chan_mid","lower":"woz_vol_rsi_ema5_chan_dn"},"upperColor":"blue","midColor":"orange","lowerColor":"blue","fillColor":"rgba(0,136,255,0.12)","lineWidth":1,"midLineWidth":1,"upperLineStyle":0,"lowerLineStyle":0}`),
		...
		wozChannel("woz_rsi_close_chan",
			`{"title":"RSI close channel","defaultVisible":false,"lastValueVisible":false,"priceLineVisible":false,"plots":{"upper":"woz_rsi_close_chan_up","mid":"woz_rsi_close_chan_mid","lower":"woz_rsi_close_chan_dn"},"upperColor":"blue","midColor":"maroon","lowerColor":"blue","fillColor":"rgba(128,0,0,0.12)","lineWidth":1,"midLineWidth":1,"upperLineStyle":0,"lowerLineStyle":0}`),
