...
//
// Mount order = Pine plot() back→front (docs/PINE_INDICATOR_SOURCES.md RSIVolume_2graf.02).
...
func WozduhComponents() []core.UIComponent {
	return []core.UIComponent{
		...
		wozLine("woz_slow", core.SlotWozduhSlow, scaleBoundedOsc,
			`{"color":"aqua","lineWidth":2,"title":"Woz slow (Aqua)","defaultVisible":true,"lastValueVisible":false,"priceLineVisible":false}`),
		wozLine("woz_fast", core.SlotWozduhFast, scaleIgnore,
			`{"color":"blue","lineWidth":2,"title":"Woz fast (Blue)","defaultVisible":true,"lastValueVisible":false,"priceLineVisible":false}`),
		...
		wozChannel("woz_vol_chan",
			`{"title":"Vol Chan","defaultVisible":false,"lastValueVisible":false,"priceLineVisible":false,"plots":{"upper":"woz_vol_chan_up","mid":"woz_vol_chan_mid","lower":"woz_vol_chan_dn"},"upperColor":"blue","midColor":"orange","lowerColor":"blue","fillColor":"rgba(0,136,255,0.12)","lineWidth":1,"midLineWidth":1,"upperLineStyle":0,"lowerLineStyle":0}`),
		...
		wozChannel("woz_price_chan",
			`{"title":"Price Chan","defaultVisible":false,"lastValueVisible":false,"priceLineVisible":false,"plots":{"upper":"woz_price_chan_up","mid":"woz_price_chan_mid","lower":"woz_price_chan_dn"},"upperColor":"blue","midColor":"maroon","lowerColor":"blue","fillColor":"rgba(128,0,0,0.12)","lineWidth":1,"midLineWidth":1,"upperLineStyle":0,"lowerLineStyle":0}`),
