...
**NEXT:** see `docs/OPEN_DEBTS.md`. **VOLUME-SOURCE-ARBITRATION-1 STEP 2 FROZEN** (`volume-truth:futures-base-v1`). **SCALE-GESTURE-OWNERSHIP-1 FROZEN.** Next research: **WOZDUH-TRUTH-1** (not started).
