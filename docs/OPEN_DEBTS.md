...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **FORECAST-BUNDLE-1 frozen** `a9e1228`. **OOF-FORECAST-EVIDENCE-1** next. Holdout-vs-decision fork still open. **TARGET-RESOLUTION-2** deferred. |
