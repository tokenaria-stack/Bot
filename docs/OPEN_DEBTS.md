...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **RECIPE-FREEZE-1 frozen** `c2d278a`. Next when asked: **FINAL-MODEL-FIT-1**. **TARGET-RESOLUTION-2** deferred. |
