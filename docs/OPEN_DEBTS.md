...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **FORECAST-BUNDLE-1 frozen** `a9e1228`. Holdout-vs-decision fork open. **TARGET-RESOLUTION-2** deferred. |
