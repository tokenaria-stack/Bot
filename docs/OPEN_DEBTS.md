...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **MODEL-FIT-1 frozen** `0d60270`. Next when asked: **CALIBRATION-1**. **TARGET-RESOLUTION-2** deferred. |
