...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **DECISION-CONTRACT-1 frozen** `b7a76b4`. Next: DECISION-RESEARCH-1. Holdout-vs-decision fork still open. **TARGET-RESOLUTION-2** deferred. |
