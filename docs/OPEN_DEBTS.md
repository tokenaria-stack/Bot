...
2. **FALCON-LIVE-ORPHAN-STREAM-1 implemented** — unpublished Live Falcon extra stream gone; production ticks no longer `Evaluate`. Frame.falcon and `ApplyBacktestRSXConfig` still exist. Next: **FALCON-ORACLE-REPLACE-1**, then unwire / `FALCON-REMOVE-1`. **WOZDUH-TRUTH-1** after Falcon retirement. **FALCON-HTF-OSC-DEAD-1** frozen `f921ee0`. **ANALOGUE-MEMORY-RESEARCH-1** parked.
