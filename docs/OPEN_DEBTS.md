...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **FINAL-MODEL-FIT-1 frozen** `9cb03f5`. Next when asked: **FORECAST-BUNDLE-1**. **TARGET-RESOLUTION-2** deferred. |
