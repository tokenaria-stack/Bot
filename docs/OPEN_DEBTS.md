...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **OOF-FORECAST-EVIDENCE-1 frozen** `124f273`. Next DECISION-VALIDATION-PLAN-1. Holdout-vs-decision fork still open. **TARGET-RESOLUTION-2** deferred. |
