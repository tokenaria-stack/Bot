...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **CALIBRATION-1 frozen** `4c8c08e`+`b550613`. **RANK-1** this chapter. Next when asked: **RECIPE-FREEZE**. **TARGET-RESOLUTION-2** deferred. |
