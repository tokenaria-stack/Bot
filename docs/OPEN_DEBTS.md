...
| # | Debt | Status | Notes |
|---|------|--------|-------|
| **76** | **ScoreNodes → Forecast engine** | 🟡 **model next** | **CALIBRATION-1 frozen** `4c8c08e`+`b550613`. Next when asked: **RANK-1**. **TARGET-RESOLUTION-2** deferred. |
