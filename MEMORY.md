...
| NEXT | **LABEL-SET-C frozen** `ce3e542`. Then **DATASET-C / VALIDATION-PLAN-C** only when asked. FEATURE-TAPE-2 frozen `61d5ca0`. FEATURE-SPEC-2 frozen `0c54848`. V1 KEEP ≠ SUPPORT. Do not start CatBoost / holdout / live host. |
