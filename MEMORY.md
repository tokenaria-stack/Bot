...
| NEXT | **DATASET-C / VALIDATION-PLAN-C frozen** `151e530`. Then **OOF-MATRIX-C** only when asked. LABEL-SET-C frozen `ce3e542`. FEATURE-TAPE-2 frozen `61d5ca0`. FEATURE-SPEC-2 frozen `0c54848`. V1 KEEP ≠ SUPPORT. Do not start CatBoost / holdout / live host. |
