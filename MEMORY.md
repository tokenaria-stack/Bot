...
| NEXT | **CATBOOST-BRAIN-1 frozen** `cecc5a3`. Next: CatBoost calibration/rank/recipe only when asked. Debt: **MODEL-IDENTITY-LAYERS-1** (`docs/DECISIONS.md`) — do not split CatBoostSpec1 until a second family/environment. |
