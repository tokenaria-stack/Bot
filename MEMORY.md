...
| NEXT | **WOZDUH-NUMERIC-NAMES-1** implemented. Next: **WOZDUH-VOLCROSS-REMOVE-1**. |
...
| Wozduh | **WOZDUH-WIRE-1 frozen** (`0c2ecce`) + **WOZDUH-ACTIVE-1A frozen** (`2cd4ca4`) + **WOZDUH-ACTIVE-1B frozen** (`1b724ef`) + **WOZDUH-NUMERIC-NAMES-1** (math-named IDs; values unchanged) |
