...
| Chart | **Frozen** — `CHART_FROZEN` + HISTORY-IDLE-PUMP-1 ✅ + **WOZDUH-X-AND-CAMERA-LEAK-1** accepted (no full zoom-out). **HISTORY-ZOOM-OUT-EDGE-1 parked.** **PRICE-SERIES-STYLE-1.1** `71c929b`. |
