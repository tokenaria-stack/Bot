...
| NEXT | **Inspect TP-vs-STOP information** after QUALITY-CURVE-1 (TIMEOUT_FILTER_RANKING). Do not reopen stop/H/+2R/wall. Do not second-ignition as if ranking were STOP-reducing. |
