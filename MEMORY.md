...
| NEXT | **CATBOOST-BRAIN-1 frozen** `cecc5a3`. Next: **FORECAST-PROJECTION-C** (causal train→val; no global recipe). **CAUSAL-PROJECTION-1** + **MODEL-IDENTITY-LAYERS-1** in `docs/DECISIONS.md`. |
