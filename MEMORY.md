...
| NEXT | **WOZDUH-VOLCROSS-REMOVE-1** implemented. Next: **WOZDUH-VISUAL-TUNE-1** (user colors). |
...
| Wozduh | **WOZDUH-WIRE-1 / ACTIVE-1A / ACTIVE-1B frozen.** **WOZDUH-NUMERIC-NAMES-1** `4cb5bdc`. **WOZDUH-VOLCROSS-REMOVE-1** (no discrete cross event). |
