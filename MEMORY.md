...
| Chart | **Frozen** — `CHART_FROZEN` + HISTORY-IDLE-PUMP-1 ✅ + SPARSE-LIVE-INGEST-1 ✅ + **SPARSE-ADR010-TIP-1 ✅** + **SCALE-GESTURE-OWNERSHIP-1 ✅** + **TIMELINE-RECOVERY-STATE-1 ✅** |
| NEXT | **WOZDUH-PANE-AUTOSCALE-OWNER-1 frozen** `1a409e9`. **CHANNEL-SPLIT-FILLS-1 frozen** `a02aa98`. **PANE-WORKSPACE-MAXIMIZE-1 frozen** `51272a9`. **WOZDUH-STYLE-SECTION-1 frozen** `b55b64f`. No `ui_config` palette retune until asked. |
...
| Wozduh | **WOZDUH-WIRE-1 / ACTIVE-1A / ACTIVE-1B frozen.** **WOZDUH-NUMERIC-NAMES-1** `4cb5bdc`. **WOZDUH-VOLCROSS-REMOVE-1** `b7202ab`. **WOZDUH-COLOR-OVERRIDES-1** `1c7ae3d`. **WOZDUH-STYLE-SECTION-1** `b55b64f`. **CHANNEL-SPLIT-FILLS-1** `a02aa98`. **WOZDUH-PANE-AUTOSCALE-OWNER-1** `1a409e9`. |
